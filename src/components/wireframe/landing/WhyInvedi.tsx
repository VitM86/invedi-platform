/**
 * WhyInvedi — the trust / positioning band. Conveys the "curated, data-rich infrastructure"
 * angle (the AngelList / PitchBook-for-new-builds idea) with four concrete points, each with an
 * icon. Light grey band to separate it from the white sections above and below.
 */
...
const POINTS = [
  {
    ...
    desc: "Every project is checked before it’s listed — developer identity, planning permits, sales mandate.",
    Icon: ShieldCheck,
  },
  {
    title: "Market overview",
    desc: "See how developments compare on price, size and location across regions and countries.",
    Icon: ChartBars,
  },
  {
    title: "Data-rich intelligence",
    desc: "Plans, prices, availability and neighbourhood context, gathered in one consistent place.",
    Icon: DocText,
  },
  {
    title: "Discovery to deal",
    desc: "A clear path from browsing a project to talking to the right person about it.",
    Icon: Trending,
  },
];

export function WhyInvedi() {
  return (
      ...
      <div className="mx-auto max-w-[1440px] px-6 py-16 lg:px-10 lg:py-24">
        ...
        <div className="mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {POINTS.map(({ title, desc, Icon }) => (
            <div key={title}>
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-surface-tint text-primary">
                <Icon />
              </div>
